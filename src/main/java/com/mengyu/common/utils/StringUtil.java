	...
	//TODO 实现代码
		...
		for (int i = 0; i < length; i++) {
			...
			if(str.equals(new String (str.getBytes("GB2312"),"GB2312"))) {
				...
				return randomChineseString(length-i);
			}
		}
		return str1;
	}
